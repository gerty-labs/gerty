...
func TestReadAnnotations_Found(t *testing.T) {
	annotations := map[string]string{
		"sage.io/repo":  "github.com/acme/manifests",
		"sage.io/path":  "apps/api/deployment.yaml",
		"sage.io/field": "resources.requests.cpu",
	}
...
func TestFormatBranchName(t *testing.T) {
	branch := FormatBranchName("sage-rightsizing", "production", "api-gateway")
	assert.True(t, strings.HasPrefix(branch, "sage-rightsizing/production-api-gateway-"))
...
func TestFormatPRBody(t *testing.T) {
	...
	assert.Contains(t, body, "k8s-sage")
}
